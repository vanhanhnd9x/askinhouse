...
<body <?php body_class($class); ?>> 
	...
	<div id="containerper">
		<div class="head-top">
            ...
            <div class="fb-like" data-href="https://www.facebook.com/vietfuture1/" data-layout="button" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
		</div>
		<div id="header">
