	...
	ob_start();
		...
		<div class="nemus-slider animation-<?php echo $slider_animation; ?> <?php echo $slider_inside_control; ?> <?php echo $slider_orientation; ?> <?php echo $slider_image_scale; ?> <?php echo $slider_carousel_class; ?>" id="nemus-slider-<?php echo $id; ?>" data-autoplay="<?php echo $slider_autoplay; ?>" data-autoplay-delay="<?php echo $slider_autoplay_delay; ?>" style="height:<?php echo $slider_height; ?>" data-animation="<?php echo $slider_animation; ?>" data-autoheight="<?php echo $slider_autoheight; ?>" data-orientation="<?php echo $slider_orientation; ?>"<?php echo $slider_carousel_attr; ?> <?php echo $advanced_settings; ?> data-content_width="<?php global $content_width; echo $content_width; ?>">
			...
			<?php foreach ($slide_data as $slide): ?>
				...
				<?php if(!isset($slide['autoslide'])): ?>
					<li class="slide col-sm-12 slide-<?php echo $slide_id; ?>">
						<?php
						...
						?>
						<?php if($slide['video']): ?>
							<div class="slide-image col-sm-3 slide-image-video" style="background:url(<?php echo $slide['image']; ?>) no-repeat left center;height: <?php echo $slider_height; ?>;">
						...
						<?php else: ?>
							...
							<?php else: ?>
								<div class="slide-image col-sm-3" style="background:url(<?php echo $slide['image']; ?>) no-repeat left center;height: <?php echo $slider_height; ?>;"></div>	
							<?php endif; ?>
						<?php endif; ?>
						...
						<?php if(isset($slide['caption'])): ?>
							...
							?>
							<div class="caption col-sm-9 <?php echo $position; ?> anim-<?php if (isset($slide['animation_position'])) echo $slide['animation_position']; ?>">
				...
				<?php else: ?>
					...
					if ($slide['auto_slide']['type'] == '' || $slide['auto_slide']['type'] == 'posts'): ?>
						...
						<?php if(apply_filters( 'nemus-slider-auto-slide-has-thumbnail', has_post_thumbnail(), $id )): ?>
							<li class="slide col-sm-12 slide-<?php echo $slide_id; ?> autoslide-<?php the_ID(); ?>">
								<?php $thumb = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), apply_filters('nemus-slider-image-size','full',$id)); ?>
								<?php if($slider_autoheight): ?>
									<img src="<?php echo $thumb[0]; ?>" />	
								<?php else: ?>
									<div class="slide-image col-sm-3" style="background:url(<?php echo $thumb[0]; ?>) no-repeat left center;height: <?php echo $slider_height; ?>;"></div>
								<?php endif; ?>
								<?php
								$position = 'tl';
								if (isset($slide['caption_position'])) {
					...
					if ($slide['auto_slide']['type'] == 'attached'): ?>
						...
						if( $attachments ): ?>
							...
							<?php foreach( $attachments as $attachment ): ?>
								...
								<li class="slide col-sm-12 slide-<?php echo $slide_id; ?> attachment-<?php echo $attachment->ID; ?>">
									<?php if($slider_autoheight): ?>
										<img src="<?php echo $attachment_img[0]; ?>" />	
									<?php else: ?>
										<div class="slide-image col-sm-3" style="background:url(<?php echo $attachment_img[0]; ?>) no-repeat left center;height: <?php echo $slider_height; ?>;"></div>
									<?php endif; ?>
									...
									?>
									<div class="caption col-sm-9 <?php echo $position; ?> anim-<?php if (isset($slide['auto_slide']['attached']['animation_position'])) echo $slide['auto_slide']['attached']['animation_position']; ?>">
