...
//2.1 changes end	
		...
		if ($smooth_slider['image_only'] == '1') { 
		   ...
		   if($permalink!='') {
			$html .= '<h2 '.$smooth_slider_css['smooth_slider_h2'].'><a '.$smooth_slider_css['smooth_slider_h2_a'].' href="'.$permalink.'">'.$post_title.'</a></h2><div class="vnc" '.$smooth_slider_css['smooth_slider_span'].'> '.$slider_excerpt.'</div>
		   ...
		   $html .= '<h2 '.$smooth_slider_css['smooth_slider_h2'].'>'.$post_title.'</h2><div class="vnc" '.$smooth_slider_css['smooth_slider_span'].'> '.$slider_excerpt.'</div>
				<!-- /smooth_slideri -->
			</div>';    
		   }
	      }
